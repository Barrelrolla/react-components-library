import{j as r}from"./iframe-2xTwKzkK.js";import{A as n}from"./Anchor-CP6LDDir.js";import"./bundle-mjs-CFgYV38x.js";const{expect:d,within:h}=__STORYBOOK_MODULE_TEST__,v={title:"Components/Anchor",tags:["autodocs"],component:n,decorators:e=>r.jsx("div",{className:"storybookContainer",children:r.jsx(e,{})}),argTypes:{children:{name:"text"},color:{control:{type:"select"}},href:{if:{arg:"false",exists:!0}},ref:{if:{arg:"false",exists:!0}},as:{control:{disable:!0}}}},t={play:async({canvasElement:e})=>{const m=h(e).getByText("Link");await d(m,"renders").toBeTruthy()},render:({children:e,...o})=>r.jsx(n,{href:"#",...o,children:e}),args:{children:"Link"}},s={render:({...e})=>r.jsxs("p",{children:["Lorem ipsum"," ",r.jsx(n,{href:"#",...e,children:"dolor"})," ","sit amet consectetur adipisicing elit. Velit vel iste veniam ut cumque dolores"," ",r.jsx(n,{"data-selected":!0,href:"#",...e,children:"inventore"})," ","natus molestiae totam temporibus, aperiam voluptates aut excepturi possimus praesentium"," ",r.jsx(n,{href:"#",...e,children:"mollitia"})," ","odio culpa quis!"]}),argTypes:{children:{if:{exists:!0,global:"true"}}}};var a,i,c;t.parameters={...t.parameters,docs:{...(a=t.parameters)==null?void 0:a.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
...
}`,...(p=(u=s.parameters)==null?void 0:u.docs)==null?void 0:p.source}}};const y=["Default","InText"];export{t as Default,s as InText,y as __namedExportsOrder,v as default};
