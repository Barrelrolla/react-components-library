import{j as r}from"./iframe-CQt0MMLO.js";import{A as n}from"./Anchor-5c7i7wvF.js";import{a as d}from"./index-DnWjc-IH.js";import"./preload-helper-Dp1pzeXC.js";import"./bundle-mjs-169JcMJR.js";const{expect:h,within:x}=__STORYBOOK_MODULE_TEST__,T={title:"Components/Anchor",tags:["autodocs"],component:n,decorators:e=>r.jsx("div",{className:"storybookContainer",children:r.jsx(e,{})}),argTypes:{children:{name:"text"},color:{options:d,control:{type:"select"},table:{defaultValue:{summary:"main"}}},href:{table:{disable:!0}},ref:{table:{disable:!0}},as:{table:{disable:!0}}}},t={play:async({canvasElement:e})=>{const p=x(e).getByText("Link");await h(p,"renders").toBeTruthy()},render:({children:e,...a})=>r.jsx(n,{href:"#",...a,children:e}),args:{children:"Link"}},s={render:({...e})=>r.jsxs("p",{children:["Lorem ipsum"," ",r.jsx(n,{href:"#",...e,children:"dolor"})," ","sit amet consectetur adipisicing elit. Velit vel iste veniam ut cumque dolores"," ",r.jsx(n,{"data-selected":!0,href:"#",...e,children:"inventore"})," ","natus molestiae totam temporibus, aperiam voluptates aut excepturi possimus praesentium"," ",r.jsx(n,{href:"#",...e,children:"mollitia"})," ","odio culpa quis!"]}),argTypes:{children:{table:{disable:!0}}}};var o,i,c;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
