import{j as n}from"./iframe-AbiaHdMx.js";import{B as c}from"./Badge-DeuJDUAV.js";import{a as o}from"./index-DhdEVH7N.js";import"./preload-helper-PPVm8Dsz.js";import"./bundle-mjs-BeSpa7as.js";const{expect:l,within:d}=__STORYBOOK_MODULE_TEST__,u={title:"Components/Badge",tags:["autodocs"],component:c,decorators:e=>n.jsx("div",{className:"storybookContainer",children:n.jsx(e,{})}),argTypes:{children:{name:"text"},color:{options:o,control:{type:"select"}}}},r={play:async({canvasElement:e})=>{const t=d(e).getByText("Badge");await l(t,"renders").toBeTruthy()},render:({children:e,...a})=>n.jsx(c,{...a,children:e}),args:{children:"Badge"}},s={play:async({canvasElement:e})=>{const t=d(e).getAllByText(/^(main|light|dark|primary|secondary|accent|info|success|warning|error)$/);await l(t).toHaveLength(o.length)},render:({...e})=>n.jsx("div",{className:"flex flex-wrap gap-2",children:o.map(a=>n.jsx(c,{color:a,...e,children:a},a))}),args:{},argTypes:{color:{table:{disable:!0}},children:{table:{disable:!0}}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
