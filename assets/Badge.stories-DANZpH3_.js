import{j as n}from"./iframe-YYkmocuX.js";import{B as c}from"./Badge-Dk_tcekC.js";import{a as o}from"./index-DnWjc-IH.js";import"./preload-helper-Dp1pzeXC.js";import"./bundle-mjs-169JcMJR.js";const{expect:y,within:u}=__STORYBOOK_MODULE_TEST__,f={title:"Components/Badge",tags:["autodocs"],component:c,decorators:e=>n.jsx("div",{className:"storybookContainer",children:n.jsx(e,{})}),argTypes:{children:{name:"text"},color:{options:o,control:{type:"select"}}}},r={play:async({canvasElement:e})=>{const t=u(e).getByText("Badge");await y(t,"renders").toBeTruthy()},render:({children:e,...a})=>n.jsx(c,{...a,children:e}),args:{children:"Badge"}},s={play:async({canvasElement:e})=>{const t=u(e).getAllByText(/^(main|light|dark|primary|secondary|accent|info|success|warning|error)$/);await y(t).toHaveLength(o.length)},render:({...e})=>n.jsx("div",{className:"flex flex-wrap gap-2",children:o.map(a=>n.jsx(c,{color:a,...e,children:a},a))}),args:{},argTypes:{color:{table:{disable:!0}},children:{table:{disable:!0}}}};var l,d,i;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
