import{j as n}from"./iframe-2xTwKzkK.js";import{H as s,T as C,B as L}from"./icons-CdlL9hCZ.js";import{B as r}from"./Button-D6w_sEDH.js";import"./bundle-mjs-CFgYV38x.js";const{expect:F,within:O}=__STORYBOOK_MODULE_TEST__,K={title:"Components/Button",component:r,tags:["autodocs"],decorators:t=>n.jsx("div",{className:"storybookContainer",children:n.jsx(t,{})}),argTypes:{children:{name:"text"},color:{control:{type:"select"}},variant:{control:{type:"inline-radio"}},ghostHover:{control:{type:"inline-radio"},if:{arg:"variant",eq:"ghost"}},size:{control:{type:"inline-radio"}},radius:{control:{type:"inline-radio"}},loadingPosition:{control:{type:"inline-radio"}},startIcon:{if:{arg:"false",exists:!0}},endIcon:{if:{arg:"false",exists:!0}},ref:{if:{arg:"false",exists:!0}},as:{control:{disable:!0}}}},o={play:async({canvasElement:t})=>{const B=O(t).getByText("Button");await F(B,"renders").toBeTruthy()},render:({children:t,...e})=>n.jsx(r,{...e,children:t}),args:{children:"Button"}},a={render:({children:t,...e})=>n.jsxs(n.Fragment,{children:[n.jsx(r,{...e,children:t}),n.jsx(r,{variant:"outline",...e,children:t}),n.jsx(r,{variant:"ghost",...e,children:t})]}),args:{children:"Button"},argTypes:{variant:{if:{arg:"false",eq:"true"}},ghostHover:{if:{arg:"false",eq:"true"}}}},c={render:({children:t,...e})=>n.jsxs(n.Fragment,{children:[n.jsx(r,{variant:"ghost",...e,children:t}),n.jsx(r,{variant:"ghost",ghostHover:"fill",...e,children:t}),n.jsx(r,{variant:"ghost",ghostHover:"outline",...e,children:t}),n.jsx(r,{variant:"ghost",ghostHover:"contrasting",...e,children:t})]}),args:{children:"Button"},argTypes:{variant:{if:{arg:"false",eq:"true"}},ghostHover:{if:{arg:"false",eq:"true"}}}},i={play:async({canvasElement:t})=>{const x=O(t).getAllByText("Button")[0].parentElement;await F(x==null?void 0:x.classList.contains("cursor-not-allowed"),"shows not allowed cursor on hover").toBeTruthy()},render:({children:t,...e})=>n.jsxs(n.Fragment,{children:[n.jsx(r,{disabled:!0,...e,children:t}),n.jsx(r,{loading:!0,...e,children:t})]}),args:{children:"Button"}},l={render:({...t})=>n.jsxs(n.Fragment,{children:[n.jsx(r,{radius:"pill",startIcon:n.jsx(s,{}),...t}),n.jsx(r,{radius:"none",variant:"outline",startIcon:n.jsx(C,{}),...t}),n.jsx(r,{variant:"ghost",ghostHover:"fill",startIcon:n.jsx(L,{}),...t})]})},u={render:({children:t,...e})=>n.jsxs(n.Fragment,{children:[n.jsx(r,{color:"main",...e,children:t}),n.jsx(r,{color:"light",...e,children:t}),n.jsx(r,{color:"dark",...e,children:t}),n.jsx(r,{color:"primary",...e,children:t}),n.jsx(r,{color:"secondary",...e,children:t}),n.jsx(r,{color:"accent",...e,children:t}),n.jsx(r,{color:"info",...e,children:t}),n.jsx(r,{color:"success",...e,children:t}),n.jsx(r,{color:"warning",...e,children:t}),n.jsx(r,{color:"error",...e,children:t})]}),args:{children:"Button"},argTypes:{color:{if:{arg:"false",eq:"true"}}}},d={render:({...t})=>n.jsxs("div",{className:"flex flex-col gap-4",children:[n.jsxs("div",{className:"flex flex-wrap items-end justify-center gap-2",children:[n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"xs",children:"Button"}),n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"sm",children:"Button"}),n.jsxs(r,{...t,size:"md",children:[n.jsx(s,{}),"Button"]}),n.jsxs(r,{...t,size:"lg",children:[n.jsx(s,{}),"Button"]}),n.jsxs(r,{...t,size:"xl",children:[n.jsx(s,{}),"Button"]})]}),n.jsxs("div",{className:"flex flex-wrap items-start justify-center gap-2",children:[n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"xs"}),n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"sm"}),n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"md"}),n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"lg"}),n.jsx(r,{...t,startIcon:n.jsx(s,{}),size:"xl"})]}),n.jsxs("div",{className:"flex w-full items-start justify-center gap-2",children:[n.jsx(r,{...t,className:"btn-xs sm:btn-sm md:btn-md lg:btn-lg xl:btn-xl",children:"responsive"}),n.jsx(r,{...t,className:"btn-icon-xs sm:btn-icon-sm md:btn-icon-md lg:btn-icon-lg xl:btn-icon-xl",startIcon:n.jsx(s,{})})]})]}),argTypes:{size:{if:{arg:"false",eq:"true"}}}};var g,m,p;o.parameters={...o.parameters,docs:{...(g=o.parameters)==null?void 0:g.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
...
}`,...(z=(H=i.parameters)==null?void 0:H.docs)==null?void 0:z.source}}};var T,w,q;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: ({
    ...rest
  }) => {
    return <>\r
...
}`,...(q=(w=l.parameters)==null?void 0:w.docs)==null?void 0:q.source}}};var N,S,E;u.parameters={...u.parameters,docs:{...(N=u.parameters)==null?void 0:N.docs,source:{originalSource:`{
  render: ({
    children,
    ...rest
  }) => {
...
}`,...(E=(S=u.parameters)==null?void 0:S.docs)==null?void 0:E.source}}};var _,k,D;d.parameters={...d.parameters,docs:{...(_=d.parameters)==null?void 0:_.docs,source:{originalSource:`{
  render: ({
    ...rest
  }) => {
...
}`,...(D=(k=d.parameters)==null?void 0:k.docs)==null?void 0:D.source}}};const M=["Default","Variants","Ghost","Disabled","Icon","Colors","Sizes"];export{u as Colors,o as Default,i as Disabled,c as Ghost,l as Icon,d as Sizes,a as Variants,M as __namedExportsOrder,K as default};
