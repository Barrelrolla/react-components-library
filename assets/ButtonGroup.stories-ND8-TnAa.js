import{r as c,j as e}from"./iframe-F_9iFa0o.js";import{P as k,a as H,b as N,c as j}from"./index-BSeDRl-I.js";import{c as I,a as G}from"./index-DttbUWqL.js";import{a as L}from"./buttonTypes-88wVwBmo.js";import"./Anchor-CcG5C7N9.js";import"./Badge-JIqud9hb.js";import{B as s}from"./Button-DnwBMCs4.js";import{B as d}from"./ButtonGroup-FIfTIULV.js";import"./PopoverTrigger-CjwtfWOw.js";import"./DarkModeToggle-hgc3vk1T.js";import"./DarkModeSelector-PkBsK7UA.js";import"./DropdownTrigger-BvFZQE80.js";import"./Divider-CgZ_8vTK.js";import"./HamburgerButton-BTBfEUvq.js";import{I as w}from"./AutocompleteInput-Ch8MfnxW.js";import"./Checkbox-PI6KsMoO.js";import"./RadioGroup-Q-4rQYoi.js";import{T as u,a as p,b}from"./TooltipContent-u51kQTSg.js";import"./SidemenuItem-d1AAgXbp.js";import{S as E,a as P,b as A,c as D}from"./SelectOption-W2gnnI4S.js";import"./Skeleton-C1wavBOs.js";import"./AutocompleteTrigger-BSzJnFi5.js";import{C as O}from"./Combobox-C8osjXd1.js";import"./Pagination-C1x3P-ke.js";import"./preload-helper-PPVm8Dsz.js";import"./cssColorProps-D-Xi89r8.js";import"./bundle-mjs-Ct12j0u0.js";import"./icons-Bf7NpFcQ.js";import"./FloatingElementContent-JtyTiY7o.js";import"./useIsMobile-2ii7qsNg.js";import"./Slot-Brczf_Sn.js";import"./helpers-DNbzzbGn.js";import"./getSelectClasses-u7PnKlIX.js";const{expect:m,within:S}=__STORYBOOK_MODULE_TEST__,xe={title:"Components/ButtonGroup",tags:["autodocs"],component:d,decorators:n=>e.jsx("div",{className:"storybookContainer",children:e.jsx(n,{})}),args:{selection:!0},argTypes:{selection:{control:{type:"boolean"},table:{category:"storybook"}},color:{control:{type:"select"},options:G,table:{category:"controls"}},variant:{control:{type:"inline-radio"},table:{category:"controls"}},size:{control:{type:"inline-radio"},options:I,table:{category:"controls"}},radius:{control:{type:"inline-radio"},table:{category:"controls"}},retainFocusState:{table:{category:"controls"}},divider:{table:{category:"controls"}},vertical:{table:{category:"controls"}},scaling:{table:{category:"controls"}},tooltipDelay:{table:{category:"controls"}},dividerClassName:{control:!1,table:{category:"docs"}},wrapperClassName:{control:!1,table:{category:"docs"}},children:{table:{disable:!0}}}},v={play:async({canvasElement:n})=>{const t=S(n).getAllByRole("button");await m(t).toHaveLength(3),await t[0].click(),await m(t[0]).toHaveAttribute("data-selected","true")},render:({selection:n,...r})=>{const[t,i]=c.useState(void 0);c.useEffect(()=>{n||i(void 0)},[n]);const a=l=>{n&&i(l)};return e.jsxs(d,{...r,children:[e.jsx(s,{selected:t===0,onClick:()=>a(0),children:"button"}),e.jsx(s,{selected:t===1,onClick:()=>a(1),children:"button"}),e.jsx(s,{selected:t===2,onClick:()=>a(2),children:"button"})]})}},g={render:({selection:n,...r})=>{const[t,i]=c.useState(void 0);c.useEffect(()=>{n||i(void 0)},[n]);const a=l=>{n&&i(l)};return e.jsx(e.Fragment,{children:L.map((l,o)=>c.createElement(d,{...r,key:l,variant:l},e.jsx(s,{selected:t===0+3*o,onClick:()=>a(0+3*o),children:l}),e.jsx(s,{selected:t===1+3*o,onClick:()=>a(1+3*o),children:l}),e.jsx(s,{selected:t===2+3*o,onClick:()=>a(2+3*o),children:l})))})},argTypes:{variant:{table:{disable:!0}},tooltipDelay:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},x={play:async({canvasElement:n})=>{const t=S(n).getByTestId("button-group");await m(t).toHaveClass("flex-col")},render:({selection:n,variant:r="outline",vertical:t=!0,...i})=>{const[a,l]=c.useState(void 0);c.useEffect(()=>{n||l(void 0)},[n]);const o=B=>{n&&l(B)};return e.jsxs(d,{variant:r,vertical:t,...i,"data-testid":"button-group",children:[e.jsx(s,{selected:a===0,onClick:()=>o(0),children:"button"}),e.jsx(s,{selected:a===1,onClick:()=>o(1),children:"button"}),e.jsx(s,{selected:a===2,onClick:()=>o(2),children:"button"})]})},argTypes:{vertical:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},C={play:async({canvasElement:n})=>{const t=S(n).getAllByRole("button");await m(t).toHaveLength(3),await m(t[0]).toHaveClass("btn-icon-md")},render:({variant:n="solid",radius:r="pill",selection:t,...i})=>{const[a,l]=c.useState(void 0);c.useEffect(()=>{t||l(void 0)},[t]);const o=B=>{t&&l(B)};return e.jsxs(d,{variant:n,radius:r,...i,children:[e.jsxs(u,{isLabel:!0,children:[e.jsx(p,{children:e.jsx(s,{"aria-label":"love",selected:a===0,onClick:()=>o(0),startIcon:e.jsx(k,{})})}),e.jsx(b,{children:"Love"})]}),e.jsxs(u,{isLabel:!0,children:[e.jsx(p,{children:e.jsx(s,{"aria-label":"like",selected:a===1,onClick:()=>o(1),startIcon:e.jsx(H,{})})}),e.jsx(b,{children:"Like"})]}),e.jsxs(u,{isLabel:!0,children:[e.jsx(b,{children:"Save"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"save",selected:a===2,onClick:()=>o(2),startIcon:e.jsx(N,{})})})]})]})},argTypes:{dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},h={play:async({canvasElement:n})=>{const t=S(n).getAllByRole("button");await m(t).toHaveLength(2)},render:({variant:n="solid",radius:r="pill",...t})=>e.jsxs(d,{...t,variant:n,radius:r,children:[e.jsx(s,{className:"",children:"Button"}),e.jsxs(u,{isLabel:!0,children:[e.jsx(b,{children:"Like"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"like",startIcon:e.jsx(k,{})})})]})]}),args:{selection:void 0},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},T={render:({variant:n="solid",...r})=>e.jsxs(d,{...r,variant:n,children:[e.jsx(w,{placeholder:"Type to search"}),e.jsxs(u,{children:[e.jsx(b,{children:"Search"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"search",startIcon:e.jsx(j,{})})})]})]}),args:{selection:void 0,divider:!1},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},f={render:({variant:n="solid",...r})=>{const t=[{name:"Documents",value:"Documents"},{name:"Images",value:"Images"}];return e.jsxs(d,{...r,variant:n,children:[e.jsx(w,{placeholder:"Choose file name"}),e.jsx(E,{items:t,placeholder:"Select file type",wrapperClassName:"w-50","aria-label":"Select file type",children:e.jsx(P,{children:e.jsx(A,{children:t.map((i,a)=>e.jsx(D,{index:a,children:i.name},i.value))})})})]})},args:{selection:void 0,variant:"outline"},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},y={render:({variant:n="solid",...r})=>e.jsxs(d,{...r,variant:n,children:[e.jsx(O,{items:[],toggleOpenAriaLabel:"Toggle list","aria-label":"Search"}),e.jsxs(u,{children:[e.jsx(b,{children:"Search"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"Search",startIcon:e.jsx(j,{})})})]})]}),args:{selection:void 0,divider:!1},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
        ...
        <Select items={items} placeholder="Select file type" wrapperClassName="w-50" aria-label="Select file type">\r
          <SelectContent>\r
            <SelectGroup>\r
              ...
              return <SelectOption index={index} key={item.value}>\r
                    {item.name}\r
                  </SelectOption>;
            })}\r
            </SelectGroup>\r
...
}`,...y.parameters?.docs?.source}}};const Ce=["Default","Varinats","Vertical","Icon","SplitButton","WithInput","WithSelect","WithCombobox"];export{v as Default,C as Icon,h as SplitButton,g as Varinats,x as Vertical,y as WithCombobox,T as WithInput,f as WithSelect,Ce as __namedExportsOrder,xe as default};
