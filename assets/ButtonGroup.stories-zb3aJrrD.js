import{r as c,j as e}from"./iframe-C8KOGUx2.js";import{P as B,a as H,b as N,c as j}from"./index-x6WoGDPP.js";import{c as G,a as I}from"./index-DttbUWqL.js";import{a as L}from"./buttonTypes-88wVwBmo.js";import"./Anchor-rFKeucJX.js";import"./Badge-CI2II2jK.js";import{a as d,B as s}from"./ButtonGroup-BRq2mKe4.js";import"./PopoverTrigger-CxdIAyBJ.js";import"./DarkModeToggle-tHC05-bQ.js";import"./DarkModeSelector-oDWjdH7u.js";import{C as E}from"./Combobox-Cew3lWqX.js";import"./Divider-CP-4uY48.js";import"./HamburgerButton-Bzg7zkAZ.js";import{I as w}from"./AutocompleteInput-BZUGZvUV.js";import"./Checkbox-nTJdBJuY.js";import"./RadioGroup-CdUkHJVG.js";import{T as u,a as p,b}from"./TooltipContent-tg41VTgy.js";import"./SidemenuItem-Bg2UdGfL.js";import{S as P,a as A,b as O,c as D}from"./SelectOption-BEOe9FU9.js";import"./Skeleton-DBNVPYgH.js";import"./preload-helper-PPVm8Dsz.js";import"./cssColorProps-BldbZDxN.js";import"./bundle-mjs-Ct12j0u0.js";import"./icons-C8I_aUnW.js";import"./FloatingElementContent-BfnogGtk.js";import"./useIsMobile-DfGPh0Mw.js";import"./helpers-KWlkL90F.js";const{expect:m,within:S}=__STORYBOOK_MODULE_TEST__,ue={title:"Components/ButtonGroup",tags:["autodocs"],component:d,decorators:n=>e.jsx("div",{className:"storybookContainer",children:e.jsx(n,{})}),args:{selection:!0},argTypes:{selection:{control:{type:"boolean"},table:{category:"storybook"}},color:{control:{type:"select"},options:I,table:{category:"controls"}},variant:{control:{type:"inline-radio"},table:{category:"controls"}},size:{control:{type:"inline-radio"},options:G,table:{category:"controls"}},radius:{control:{type:"inline-radio"},table:{category:"controls"}},retainFocusState:{table:{category:"controls"}},divider:{table:{category:"controls"}},vertical:{table:{category:"controls"}},scaling:{table:{category:"controls"}},tooltipDelay:{table:{category:"controls"}},dividerClassName:{control:!1,table:{category:"docs"}},wrapperClassName:{control:!1,table:{category:"docs"}},children:{table:{disable:!0}}}},g={play:async({canvasElement:n})=>{const t=S(n).getAllByRole("button");await m(t).toHaveLength(3),await t[0].click(),await m(t[0]).toHaveAttribute("data-selected","true")},render:({selection:n,...r})=>{const[t,i]=c.useState(void 0);c.useEffect(()=>{n||i(void 0)},[n]);const a=l=>{n&&i(l)};return e.jsxs(d,{...r,children:[e.jsx(s,{selected:t===0,onClick:()=>a(0),children:"button"}),e.jsx(s,{selected:t===1,onClick:()=>a(1),children:"button"}),e.jsx(s,{selected:t===2,onClick:()=>a(2),children:"button"})]})}},v={render:({selection:n,...r})=>{const[t,i]=c.useState(void 0);c.useEffect(()=>{n||i(void 0)},[n]);const a=l=>{n&&i(l)};return e.jsx(e.Fragment,{children:L.map((l,o)=>c.createElement(d,{...r,key:l,variant:l},e.jsx(s,{selected:t===0+3*o,onClick:()=>a(0+3*o),children:l}),e.jsx(s,{selected:t===1+3*o,onClick:()=>a(1+3*o),children:l}),e.jsx(s,{selected:t===2+3*o,onClick:()=>a(2+3*o),children:l})))})},argTypes:{variant:{table:{disable:!0}},tooltipDelay:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},x={play:async({canvasElement:n})=>{const t=S(n).getByTestId("button-group");await m(t).toHaveClass("flex-col")},render:({selection:n,variant:r="outline",vertical:t=!0,...i})=>{const[a,l]=c.useState(void 0);c.useEffect(()=>{n||l(void 0)},[n]);const o=k=>{n&&l(k)};return e.jsxs(d,{variant:r,vertical:t,...i,"data-testid":"button-group",children:[e.jsx(s,{selected:a===0,onClick:()=>o(0),children:"button"}),e.jsx(s,{selected:a===1,onClick:()=>o(1),children:"button"}),e.jsx(s,{selected:a===2,onClick:()=>o(2),children:"button"})]})},argTypes:{vertical:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},C={play:async({canvasElement:n})=>{const t=S(n).getAllByRole("button");await m(t).toHaveLength(3),await m(t[0]).toHaveClass("btn-icon-md")},render:({variant:n="solid",radius:r="pill",selection:t,...i})=>{const[a,l]=c.useState(void 0);c.useEffect(()=>{t||l(void 0)},[t]);const o=k=>{t&&l(k)};return e.jsxs(d,{variant:n,radius:r,...i,children:[e.jsxs(u,{isLabel:!0,children:[e.jsx(p,{children:e.jsx(s,{"aria-label":"love",selected:a===0,onClick:()=>o(0),startIcon:e.jsx(B,{})})}),e.jsx(b,{children:"Love"})]}),e.jsxs(u,{isLabel:!0,children:[e.jsx(p,{children:e.jsx(s,{"aria-label":"like",selected:a===1,onClick:()=>o(1),startIcon:e.jsx(H,{})})}),e.jsx(b,{children:"Like"})]}),e.jsxs(u,{isLabel:!0,children:[e.jsx(b,{children:"Save"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"save",selected:a===2,onClick:()=>o(2),startIcon:e.jsx(N,{})})})]})]})},argTypes:{dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},h={play:async({canvasElement:n})=>{const t=S(n).getAllByRole("button");await m(t).toHaveLength(2)},render:({variant:n="solid",radius:r="pill",...t})=>e.jsxs(d,{...t,variant:n,radius:r,children:[e.jsx(s,{className:"",children:"Button"}),e.jsxs(u,{isLabel:!0,children:[e.jsx(b,{children:"Like"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"like",startIcon:e.jsx(B,{})})})]})]}),args:{selection:void 0},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},T={render:({variant:n="solid",...r})=>e.jsxs(d,{...r,variant:n,children:[e.jsx(w,{placeholder:"Type to search"}),e.jsxs(u,{children:[e.jsx(b,{children:"Search"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"search",startIcon:e.jsx(j,{})})})]})]}),args:{selection:void 0},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},f={render:({variant:n="solid",...r})=>{const t=["Documents","Images"];return e.jsxs(d,{...r,variant:n,children:[e.jsx(w,{placeholder:"Choose file name"}),e.jsx(P,{items:t,placeholder:"Select file type",wrapperClassName:"w-50","aria-label":"Select file type",children:e.jsx(A,{children:e.jsx(O,{children:t.map((i,a)=>e.jsx(D,{index:a,children:i},i))})})})]})},args:{selection:void 0},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}},y={render:({variant:n="solid",...r})=>e.jsxs(d,{...r,variant:n,divider:!1,children:[e.jsx(E,{items:[],toggleOpenAriaLabel:"Toggle list","aria-label":"Search"}),e.jsxs(u,{children:[e.jsx(b,{children:"Search"}),e.jsx(p,{children:e.jsx(s,{"aria-label":"Search",startIcon:e.jsx(j,{})})})]})]}),args:{selection:void 0},argTypes:{selection:{table:{disable:!0}},dividerClassName:{table:{disable:!0}},wrapperClassName:{table:{disable:!0}}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
...
}`,...y.parameters?.docs?.source}}};const pe=["Default","Varinats","Vertical","Icon","SplitButton","WithInput","WithSelect","WithCombobox"];export{g as Default,C as Icon,h as SplitButton,v as Varinats,x as Vertical,y as WithCombobox,T as WithInput,f as WithSelect,pe as __namedExportsOrder,ue as default};
