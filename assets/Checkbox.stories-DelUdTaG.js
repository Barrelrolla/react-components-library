import{j as a}from"./iframe-CWDiRE6U.js";import{C as o}from"./Checkbox-BOi2ioOu.js";import{a as t}from"./index-Ccfv0_tG.js";import"./preload-helper-PPVm8Dsz.js";import"./bundle-mjs-169JcMJR.js";import"./icons-cedDc1Nc.js";const{expect:l,within:i}=__STORYBOOK_MODULE_TEST__,u={title:"Components/Checkbox",tags:["autodocs"],component:o,decorators:e=>a.jsx("div",{className:"storybookContainer",children:a.jsx(e,{})}),argTypes:{children:{name:"text"},color:{options:t,control:{type:"select"}},labelColor:{options:t,control:{type:"select"}},defaultChecked:{table:{disable:!0}},labelStyle:{table:{disable:!0}},labelClasses:{table:{disable:!0}},wrapperClasses:{table:{disable:!0}}}},n={play:async({canvasElement:e})=>{const c=i(e).getByText("Checkbox");await l(c,"renders").toBeTruthy()},render:({children:e,...r})=>a.jsx(o,{...r,children:e}),args:{children:"Checkbox",size:24}},s={render:({...e})=>a.jsx("div",{className:"flex flex-wrap gap-2",children:t.map(r=>a.jsx(o,{color:r,defaultChecked:!0,...e,children:r},r))}),args:{},argTypes:{color:{table:{disable:!0}},children:{table:{disable:!0}}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
