    ...
    return <>\r
        ...
        <Dialog isOpen={isOpen} setIsOpen={setIsOpen}>\r
          ...
          <Dialog isOpen={isOpenSecond} setIsOpen={setIsOpenSecond}>\r
            <Card className="max-h-[calc(100vh-2.2rem)] overflow-x-auto" size="xl">\r
              <CardTitle>Lorem, ipsum dolor.</CardTitle>\r
              <CardText>\r
...
}`,...m.parameters?.docs?.source}}};const le=["Default","BigText"];export{m as BigText,u as Default,le as __namedExportsOrder,de as default};
