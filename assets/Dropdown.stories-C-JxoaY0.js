import{j as e}from"./iframe-DaIncS6O.js";import{D as d,a as m,b as l,c as u,d as w,e as n}from"./DropdownListItem-BKKoySt4.js";import{d as h,e as y,a as T}from"./index-CikE6BH2.js";import{B as D}from"./Button-B-seHsJ1.js";import"./ButtonGroup-Dw-UV4_H.js";import{c as B}from"./index-6znNr90P.js";import"./preload-helper-PPVm8Dsz.js";import"./FloatingContext-CsgwFjJz.js";import"./useIsMobile-DyICm3E7.js";import"./FloatingElementContent-6d6fQPzb.js";import"./bundle-mjs-169JcMJR.js";import"./Anchor-Cycsa0MU.js";import"./icons-pFKqaLY3.js";import"./Divider-yOKdktT1.js";const{expect:o,screen:x,userEvent:c,within:g}=__STORYBOOK_MODULE_TEST__,P={title:"Components/Dropdown",tags:["autodocs"],component:d,decorators:t=>e.jsx("div",{className:"storybookContainer",children:e.jsx(t,{})}),argTypes:{color:{options:T,control:{type:"select"}},mobileSheetPlacement:{options:y,control:{type:"select"}},placement:{options:h,control:{type:"select"}}}},s={play:async({canvasElement:t})=>{const r=g(t),p=r.getByText("open menu");o(r.queryByText("menu")).toBeNull(),await c.click(p);const a=x.getByText("menu");o(a,"renders").toBeInTheDocument(),await c.click(document.body),o(r.queryByText("menu")).toBeNull()},render:({...t})=>e.jsxs(d,{...t,children:[e.jsx(m,{children:e.jsx(D,{children:"open menu"})}),e.jsxs(l,{children:[e.jsx(u,{children:"menu"}),e.jsxs(w,{children:[e.jsx(n,{onClick:()=>console.log("clickdd"),children:"item 1"}),e.jsx(n,{children:"item 2"}),e.jsx(n,{children:"item 3"})]})]})]})},i={play:async({canvasElement:t})=>{const r=g(t),p=r.getByText("open menu");o(r.queryByText("menu")).toBeNull(),await c.click(p);const a=x.getByText("menu");o(a,"renders").toBeInTheDocument(),await c.click(document.body),o(r.queryByText("menu")).toBeNull()},render:({...t})=>e.jsxs(d,{...t,children:[e.jsx(m,{children:e.jsx(D,{children:"open menu"})}),e.jsxs(l,{children:[e.jsx(u,{children:"menu"}),e.jsxs(w,{children:[e.jsx(n,{children:"item 1"}),e.jsx(n,{disabled:!0,children:"item 2"}),e.jsxs(d,{placement:"right",children:[e.jsx(m,{children:e.jsxs(n,{className:"flex items-center gap-1 pr-0",children:[e.jsx("span",{children:"item 3"})," ",e.jsx(B,{})]})}),e.jsxs(l,{children:[e.jsx(u,{children:"sub menu"}),e.jsxs(w,{children:[e.jsx(n,{children:"nested 1"}),e.jsx(n,{children:"nested 2"}),e.jsx(n,{children:"nested 3"})]})]})]}),e.jsx(n,{children:"item 4"})]})]})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
