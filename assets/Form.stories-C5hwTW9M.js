import{r as a,j as n}from"./iframe-Bq-qTuPV.js";import"./Anchor-D2yqvZXB.js";import"./Badge-BQ8mMiwC.js";import{B as W}from"./ButtonGroup-EdvDBeQv.js";import{f as _,b as X,a as Z}from"./PopoverTrigger-W2axUDb8.js";import"./DarkModeToggle-CKMgeKng.js";import"./DarkModeSelector-D_2oFfhK.js";import"./DropdownTrigger-CzCyJtPe.js";import"./Divider-D-yjLdOq.js";import"./HamburgerButton-BUrCfzB_.js";import{I as H}from"./AutocompleteInput-BSSDgEgz.js";import"./Checkbox-DVEcePgr.js";import"./RadioGroup-CVg6Gdvy.js";import"./TooltipContent-aILqjwYc.js";import"./SidemenuItem-BuqmDow_.js";import{S as V,a as G,b as F,c as $}from"./SelectOption-KNsnFuxO.js";import"./Skeleton-B4ldX9ik.js";import"./AutocompleteTrigger-DvQDv_pa.js";import{C as U}from"./Combobox-CsU7b7_p.js";import"./preload-helper-PPVm8Dsz.js";import"./cssColorProps-D-Xi89r8.js";import"./bundle-mjs-Ct12j0u0.js";import"./icons-BMtJpZx5.js";import"./FloatingElementContent-DTZ0t0xo.js";import"./useIsMobile-COwC63CJ.js";import"./Slot-DB_xuMy2.js";import"./helpers-CQvskJeD.js";import"./getSelectClasses-KU68FZN4.js";const{within:K,expect:o,userEvent:r}=__STORYBOOK_MODULE_TEST__,Re={title:"Test/Form"},C={play:async({canvasElement:p})=>{const s=K(p),c=K(document.body),b=s.getByTestId("text"),T=s.getByTestId("number"),S=s.getByTestId("textarea"),d=s.getByText("select one"),k=s.getByText("select many"),f=s.getByTestId("combo"),v=s.getByTestId("combo many"),y=s.getByText("submit"),t=s.getByTestId("result");await r.type(b,"test"),await r.type(T,"259"),await r.type(S,"testarea"),await r.click(d);const m=c.getByText("option 1");await r.click(m),await r.click(k);const h=c.getByText("option two");await r.click(h);const i=c.getByText("option three");await r.click(i),await r.type(f,"comb"),await r.keyboard("{Enter}"),await r.type(v,"combo two"),await r.keyboard("{Enter}"),await r.type(v,"three"),await r.keyboard("{Enter}"),await r.click(y),await o(t,"sets text state").toHaveTextContent("-text state: test-"),await o(t,"gets text from formData").toHaveTextContent("-entered text: test-"),await o(t,"gets text from ref").toHaveTextContent("-ref text: test-"),await o(t,"sets number state").toHaveTextContent("-number state: 259-"),await o(t,"gets text from formData").toHaveTextContent("-entered number: 259-"),await o(t,"gets text from ref").toHaveTextContent("-ref number: 259-"),await o(t,"sets textarea state").toHaveTextContent("-textarea state: testarea-"),await o(t,"gets textarea from formData").toHaveTextContent("-entered textarea: testarea-"),await o(t,"gets textarea from ref").toHaveTextContent("-ref textarea: testarea-"),await o(t,"sets select state").toHaveTextContent("-option state: option value 1-"),await o(t,"gets option from formData").toHaveTextContent("-selected option: option value 1-"),await o(t,"gets option from ref").toHaveTextContent("-ref option: option value 1-"),await o(t,"sets select many state").toHaveTextContent("-options state: option value two,option value three-"),await o(t,"gets options from formData").toHaveTextContent("-selected options: option value two,option value three-"),await o(t,"doesn't get options from ref").toHaveTextContent("-ref options: -"),await o(t,"sets combo state").toHaveTextContent("-combo state: combo 1-"),await o(t,"gets combo from formData").toHaveTextContent("-selected combo: combo value 1-"),await o(t,"gets combo from ref").toHaveTextContent("-ref combo: combo 1-"),await o(t,"sets combo many state").toHaveTextContent("-combo many state: combo value two,combo value three-"),await o(t,"gets combo many from formData").toHaveTextContent("-selected combo many: combo value two,combo value three-"),await o(t,"doesn't get combo many from ref").toHaveTextContent("-ref combo many: -")},render:()=>{const p=[{name:"option 1",value:"option value 1"},{name:"option 2",value:"option value 2"},{name:"option 3",value:"option value 3"}],s=[{name:"option one",value:"option value one"},{name:"option two",value:"option value two"},{name:"option three",value:"option value three"}],c=[{name:"combo 1",value:"combo value 1"},{name:"combo 2",value:"combo value 2"},{name:"combo 3",value:"combo value 3"}],b=[{name:"combo one",value:"combo value one"},{name:"combo two",value:"combo value two"},{name:"combo three",value:"combo value three"}],[T,S]=a.useState([]),[d,k]=a.useState(""),[f,v]=a.useState(""),[y,t]=a.useState(""),[m,h]=a.useState(void 0),[i,R]=a.useState([]),[O,Y]=a.useState(""),[g,M]=a.useState([]),E=a.useRef(null),N=a.useRef(null),B=a.useRef(null),j=a.useRef(null),A=a.useRef(null),D=a.useRef(null),L=a.useRef(null);function q(e){const l=e.get("text")?.toString()||"",x=e.get("number")?.toString()||"",w=e.get("textarea")?.toString()||"",I=e.get("select-one")?.toString()||"",z=e.getAll("select-many")?.toString()||"",J=e.get("combo")?.toString()||"",P=e.getAll("comboMany")?.toString()||"";S([{key:"text state",text:d},{key:"entered text",text:l},{key:"ref text",text:E.current?.value.toString()||""},{key:"number state",text:f},{key:"entered number",text:x},{key:"ref number",text:N.current?.value.toString()||""},{key:"textarea state",text:y},{key:"entered textarea",text:w},{key:"ref textarea",text:B.current?.value.toString()||""},{key:"option state",text:m!==void 0?p[m].value:""},{key:"selected option",text:I},{key:"ref option",text:j.current?.value.toString()||""},{key:"options state",text:s.filter((u,Q)=>i.includes(Q)).map(u=>u.value).join(",")},{key:"selected options",text:z},{key:"ref options",text:A.current?.value.toString()||"",error:!0},{key:"combo state",text:O},{key:"selected combo",text:c.filter(u=>u.name===J)[0].value},{key:"ref combo",text:D.current?.value.toString()||""},{key:"combo many state",text:g.map(u=>b[u].value).join(",")},{key:"selected combo many",text:P},{key:"ref combo many",text:L.current?.value.toString()||"",error:!0}])}return n.jsxs("div",{className:"flex flex-col gap-2 p-4",children:[n.jsx(_,{className:"p-4",children:n.jsxs("form",{action:q,className:"flex flex-col gap-2",children:[n.jsx(H,{wrapperClassName:"w-full","data-testid":"text",ref:E,type:"text",name:"text",label:"Text",onChange:e=>{k(e.target.value)},value:d}),n.jsx(H,{wrapperClassName:"w-full","data-testid":"number",stepUpAriaLabel:"up",stepDownAriaLabel:"down",ref:N,type:"number",name:"number",label:"Number",value:f,onChange:e=>{v(e.target.value)}}),n.jsx(H,{wrapperClassName:"w-full",ref:B,"data-testid":"textarea",as:"textarea",label:"Textarea",name:"textarea",value:y,onChange:e=>{t(e.target.value)}}),n.jsx(V,{wrapperClassName:"w-full",items:p,inputRef:j,placeholder:"select one",label:"Select one",name:"select-one",initialSelectedIndex:m,onSelectedIndexChange:h,children:n.jsx(G,{children:n.jsx(F,{children:p.map((e,l)=>n.jsx($,{index:l,children:e.name},e.value))})})}),n.jsx(V,{wrapperClassName:"w-full",items:s,inputRef:A,removeAllItemsAriaLabel:"clear",removeItemAriaLabel:"remove",multiple:!0,placeholder:"select many",label:"Select many",name:"select-many",initialSelectedIndex:m,onSelectedIndexChange:e=>{if(e===void 0)return;const l=i.indexOf(e);if(l>0){const x=i.filter((w,I)=>I!==l);R(x)}else R([...i,e])},children:n.jsx(G,{children:n.jsx(F,{children:s.map((e,l)=>n.jsx($,{index:l,children:e.name},e.value))})})}),n.jsx(U,{wrapperClassName:"w-full",toggleOpenAriaLabel:"toggle",ref:D,items:c,label:"Combo",name:"combo",value:O,placeholder:"combo","data-testid":"combo",onChange:e=>Y(e.target.value)}),n.jsx(U,{wrapperClassName:"w-full",toggleOpenAriaLabel:"toggle",multiple:!0,ref:L,items:b,name:"comboMany",label:"Combo multiple",placeholder:"combo many","data-testid":"combo many",onSelectedIndexChange:e=>{if(e===void 0)return;if(g.indexOf(e)>=0){const x=g.filter(w=>w!==e);M(x)}else M([...g,e])}}),n.jsx(W,{className:"mt-4",children:"submit"})]})}),n.jsxs(_,{children:[n.jsx(X,{children:"entered data"}),n.jsx(Z,{className:"flex flex-col","data-testid":"result",children:T.map(e=>n.jsx("span",{className:e.error?"text-error":"",children:`-${e.key}: ${e.text}-`},e.key))})]})]})}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
    ...
    return <div className="flex flex-col gap-2 p-4">\r
        <Card className="p-4">\r
          <form action={handleSubmit} className="flex flex-col gap-2">\r
            ...
            <Combobox wrapperClassName="w-full" toggleOpenAriaLabel="toggle" multiple ref={comboManyRef} items={comboMany} name="comboMany" label="Combo multiple" placeholder="combo many" data-testid="combo many" onSelectedIndexChange={i => {
            if (i === undefined) {
              return;
            }
...
}`,...C.parameters?.docs?.source}}};const Oe=["Form"];export{C as Form,Oe as __namedExportsOrder,Re as default};
