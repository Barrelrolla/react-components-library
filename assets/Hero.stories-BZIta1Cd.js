    ...
    return <div className="bg-main">\r
        <Hero {...props}>\r
          ...
          <HeroImageSection className="max-md:h-1/2 md:w-1/2">\r
            <img className="hero-image w-[50vw]" src="https://picsum.photos/1400/1400?grayscale" />\r
          </HeroImageSection>\r
        </Hero>\r
      </div>;
  }
