import{j as a}from"./iframe-BavZXKyY.js";import{a as s}from"./index-Ccfv0_tG.js";import{R as t,a as i}from"./RadioGroup-Bg3bPBiC.js";import"./preload-helper-PPVm8Dsz.js";import"./bundle-mjs-169JcMJR.js";import"./icons-CI6H4KFh.js";const{expect:c,within:d}=__STORYBOOK_MODULE_TEST__,R={title:"Components/Radio",tags:["autodocs"],component:t,decorators:e=>a.jsx("div",{className:"storybookContainer",children:a.jsx(e,{})}),argTypes:{children:{name:"text"},color:{options:s,control:{type:"select"}},labelColor:{options:s,control:{type:"select"}},defaultChecked:{table:{disable:!0}},labelStyle:{table:{disable:!0}},labelClasses:{table:{disable:!0}},wrapperClasses:{table:{disable:!0}}}},o={play:async({canvasElement:e})=>{const l=d(e).getByText("Radio");await c(l,"renders").toBeTruthy()},render:({children:e,...r})=>a.jsx(t,{...r,children:e}),args:{children:"Radio",size:20}},n={render:({...e})=>a.jsx(i,{name:"colors",title:"",className:"flex flex-wrap gap-2",children:s.map(r=>a.jsx(t,{color:r,...e,children:r},r))}),argTypes:{color:{table:{disable:!0}},children:{table:{disable:!0}}}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  play: async ({
    canvasElement
  }) => {
