import{j as e}from"./iframe-MZB_caGF.js";import{a as t}from"./index-Ccfv0_tG.js";import{a as s,R as o}from"./RadioGroup-ri2b42aq.js";import"./preload-helper-PPVm8Dsz.js";import"./bundle-mjs-169JcMJR.js";import"./icons-C6YbZSVv.js";const m={title:"Components/RadioGroup",tags:["autodocs"],component:s,decorators:a=>e.jsx("div",{className:"storybookContainer",children:e.jsx(a,{})}),argTypes:{color:{options:t,control:{type:"select"}},labelColor:{options:t,control:{type:"select"}},labelStyle:{table:{disable:!0}},defaultChecked:{table:{disable:!0}},wrapperClasses:{table:{disable:!0}},labelClasses:{table:{disable:!0}},name:{table:{disable:!0}}}},r={render:({...a})=>e.jsxs(s,{className:"flex gap-4",...a,children:[e.jsx(o,{children:"one"}),e.jsx(o,{children:"two"}),e.jsx(o,{children:"three"})]}),args:{size:20,name:"radio",title:"radio group"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: ({
    ...rest
  }) => {
