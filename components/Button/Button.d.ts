...
declare const defaultType: "button";
...
export declare function Button<E extends ElementType = typeof defaultType>({ as, color, variant, radius, ghostHover, size, retainFocusState, disabled, selected, scaling, loading, loadingPosition, startIcon, endIcon, className, wrapperClasses, style, children, ...rest }: ButtonProps<E>): import("react").JSX.Element;
export {};
