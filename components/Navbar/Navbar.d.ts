...
export declare function Navbar({ color, hasShadow, collapseAt, fixed, position, glass, style, children, className, backdropClasses, ...rest }: NavbarProps): import("react").JSX.Element;
