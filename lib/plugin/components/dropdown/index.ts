...
export default <Record<string, CssInJs>>{
  ...
  ".dropdown-mobile-top": {
    "@apply fixed top-0 left-0 w-full border-l-0 border-r-0 border-t-0": {},
  },
