...
export default <Record<string, CssInJs>>{
  ...
  ".navbar-collapse-container": {
    "@apply w-full overflow-hidden overflow-x-visible overscroll-contain motion-safe:transition-dropdown":
      {},
  },
  ...
  ".navbar-link": {
    "@apply flex hover:bg-(--fg-color)/10 focus-visible:bg-(--fg-color)/10 active:bg-(--fg-color)/30 selected:bg-(--fg-color) selected:text-(--bg-color) selected:hover:bg-(--fg-color)/90 selected:focus-visible:bg-(--fg-color)/90 selected:active:bg-(--fg-color)/80 outline-offset-1 px-1 py-2":
      {},
  },
